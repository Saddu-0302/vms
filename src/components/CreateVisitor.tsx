...
const CreateVisitor = () => {
    const [addVisitor, { isSuccess, isLoading, isError, error }] = useAddVisitorMutation()
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        />
                                        {
                                            formik.touched.name && formik.errors.name && <span className="text-red-400 ml-2">{formik.errors.name}</span>
                                        }
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        />
                                        {
                                            ...
                                            <span className="text-red-400 ml-2">{formik.errors.email}</span>
                                        }
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-2">
                                        ...
                                        />
                                        {
                                            ...
                                            <span className="text-red-400 ml-2">{formik.errors.contact}</span>
                                        }
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        />
                                        {
                                            ...
                                            <span className="text-red-400 ml-2">{formik.errors.idProof}</span>
                                        }
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-6 pt-6 border-t border-gray-100">
                                ...
                                <div className="space-y-2">
                                    ...
                                    />
                                    {
                                        ...
                                        <span className="text-red-400 ml-2">{formik.errors.host}</span>
                                    }
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    />
                                    {
                                        ...
                                        <span className="text-red-400 ml-2">{formik.errors.purpose}</span>
                                    }
                                </div>
                            </div>
